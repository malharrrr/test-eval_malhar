...
export default function DashboardPage() {
  ...
  const startRun = async () => {
    ...
    try {
      ...
      const response = await fetch(`${serverUrl}/api/v1/runs`, {
        method: "POST",
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-500 text-sm mt-1">Trigger and monitor your LLM extraction tests.</p>
          </div>
          ...
          <div className="flex gap-4">
            <select 
              ...
              className="border border-gray-300 rounded-lg px-4 py-2 text-sm bg-white text-gray-900 focus:ring-2 focus:ring-blue-500 focus:outline-none"
              disabled={isRunning}
            >
